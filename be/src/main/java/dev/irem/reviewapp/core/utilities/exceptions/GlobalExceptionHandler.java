...
public class GlobalExceptionHandler {
    ...
    public ResponseEntity<Map<String, Object>> handleValidationErrors(MethodArgumentNotValidException ex) {
        ...
        return new ResponseEntity<Map<String, Object>>(getErrorsMap(errors, "Validation.Exception"),
    ...
    public ResponseEntity<Map<String, Object>> handleTaskNotFound(TaskNotFoundException ex) {
        List<String> errors = Collections.singletonList(ex.getMessage());
        return new ResponseEntity<Map<String, Object>>(getErrorsMap(errors, "Runtime.Exception"),
                HttpStatus.UNPROCESSABLE_ENTITY);
    }
    ...
    public ResponseEntity<Map<String, Object>> handleAuthenticationServiceException(AuthenticationServiceException ex) {
        List<String> errors = Collections.singletonList(ex.getMessage());
        return new ResponseEntity<Map<String, Object>>(getErrorsMap(errors, "Authentication.Exception"),
                HttpStatus.UNPROCESSABLE_ENTITY);
    }
    ...
    public final ResponseEntity<Map<String, Object>> handleGeneralExceptions(Exception ex) {
        List<String> errors = Collections.singletonList(ex.getMessage());
        return new ResponseEntity<Map<String, Object>>(getErrorsMap(errors, "General.Exception"),
